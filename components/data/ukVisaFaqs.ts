export const ukVisaFaqs: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Typically an attested marriage certificate, proof of the sponsor's UK income or savings meeting the minimum financial requirement, accommodation evidence, and proof of an ongoing relationship. We confirm the current financial threshold, since it's reviewed periodically by UK authorities.",
  },
  {

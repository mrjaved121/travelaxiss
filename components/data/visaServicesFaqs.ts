export const visaServicesFaqs: { q: string; a: string }[] = [
  {
    q: "Do you issue UAE visas yourselves?",
    a: "No. We prepare and organize your documentation; the visa itself is issued by the relevant UAE government authority (ICP or GDRFA), not by us.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes — we support documentation for visa renewals and cancellation formalities, coordinated through official channels.",
  },
];

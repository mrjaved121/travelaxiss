          ...
          >
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="rounded-3xl p-6 bg-white">
                <h3 className="font-bold mb-3" style={{ color: "#071A2B" }}>From you</h3>
              ...
              <div className="rounded-3xl p-6 bg-white">
                <h3 className="font-bold mb-3" style={{ color: "#071A2B" }}>From your employer</h3>
                <ul className="space-y-2">
                  {[
          ...
          >
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={m} className="flex items-center gap-3 p-4 rounded-lg border-l-4" style={{ backgroundColor: "#EAF1FF", borderColor: "#A23F35" }}>

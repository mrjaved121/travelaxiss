    ...
    <div>
      <section className="py-20" style={{ backgroundColor: '#F5F5F5' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6" style={{ backgroundColor: '#C9A24A' }} aria-hidden>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            ...
            className="mb-12"
          >
            <label htmlFor={searchFieldId} className="block text-center text-sm font-semibold mb-3" style={{ color: '#111111' }}>
          ...
          <motion.div
            ...
            className="mb-12"
          >
            <p id={categoryGroupLabelId} className="text-center text-sm font-semibold mb-3" style={{ color: '#111111' }}>
              Filter by topic
            </p>
                ...
                return (
                  <motion.li
                    ...
                    style={{ 
                      ...
                      borderColor: isOpen ? '#C9A24A' : '#F5F5F5'
                    }}
                  >
                    <div
                    ...
                    >
                      <h3 id={headId} className="m-0 flex-1 min-w-0 text-lg font-bold" style={{ color: '#111111' }}>
                        <button
                          type="button"

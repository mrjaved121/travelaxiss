...
const coreServices: { title: string; description: string; icon: LucideIcon; link: string }[] = [
  ...
  },
  {
    ...
    description: "Approvals, Chamber of Commerce services, and multi-authority coordination.",
    icon: FileText,
...
export default function EmiratePage({ emirate }: { emirate: Emirate }) {
  const faqs = [...emirate.faqs, ...generalFaqs];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6" style={{ color: '#0F1B2D' }}>
              ...
              <span style={{ color: '#1D63E0' }}>{emirate.name}</span>
            </h1>

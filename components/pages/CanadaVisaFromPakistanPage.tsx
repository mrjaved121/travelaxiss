  ...
  return (
    <div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight" style={{ color: "#0F1B2D" }}>
              Canada Visa <span style={{ color: "#1D63E0" }}>from Pakistan</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                <span>Get a Free Canada Visa Consultation</span>
      ...
      <section className="relative py-24 overflow-hidden" style={{ backgroundColor: "#1D63E0" }}>
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Start Your Canada Visa Application</h2>
